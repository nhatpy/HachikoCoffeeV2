...
const products = [
    { id: "1", name: "Sản phẩm 1" },
    { id: "2", name: "Sản phẩm 2" },
    { id: "3", name: "Sản phẩm 3" },
    { id: "4", name: "Sản phẩm 4" },
    { id: "5", name: "Sản phẩm 5" },
    { id: "6", name: "Sản phẩm 6" },
    { id: "7", name: "Sản phẩm 7" },
    { id: "8", name: "Sản phẩm 8" },
];
                    ...
                    <View className="flex-row items-center justify-between px-4 py-3 border-b border-gray-300">
                        <View className="flex-row items-center">
                            ...
                            <View className="ml-3">
                                ...
                                <Text className="text-gray-500 text-sm">ID sản phẩm {item.id}</Text>
                            </View>
                        </View>
